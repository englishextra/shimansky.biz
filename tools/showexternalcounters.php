...
?></tbody></table>
		...
		<script>
			...
			if(/^(localhost|127.0.0.1)/.test(window.location.host||"")){loadCSS("../libs/admin/css/bundle.css");}else{loadCSS("../libs/admin/css/bundle.min.css");}
		</script>
		<script>
				...
				if("undefined"===typeof window.Element&&!("classList"in document.documentElement)){if(navigator.userAgent.match(/Trident\/7\./)){loadJS("../cdn/classlist-polyfill/1.1.20150312/js/classList.fixed.min.js");}}
		...
		<script>
				if(/^(localhost|127.0.0.1)/.test(window.location.host||"")){loadJS("../libs/admin/js/bundle.js");}else{loadJS("../libs/admin/js/bundle.min.js");}
		</script>
	</body>
</html>
